...
const (
	...
	spade         = 3
	clubOffset    = 13 * club
	diamondOffset = 13 * diamond
	heartOffset   = 13 * heart
	spadeOffset   = 13 * spade
)
...
const (
	handtypeShift          = 24
	topCardShift           = 16
	topCardMask     uint64 = 0x000F0000
	secondCardShift        = 12
	secondCardMask  uint64 = 0x0000F000
	thirdCardShift         = 8
	fourthCardShift        = 4
	fifthCardShift         = 0
	fifthCardMask   uint64 = 0x0000000F
	cardWidth              = 4
	oneCardMask     uint64 = 0x0F
)
...
// Hand type value
const (
	handtypeValueStraightFlush = uint64(StraightFlush << handtypeShift)
	handtypeValueStraight      = uint64(Straight << handtypeShift)
	handtypeValueFlush         = uint64(Flush << handtypeShift)
	handtypeValueFullHouse     = uint64(FullHouse << handtypeShift)
	handtypeValueFourOfAKind   = uint64(FourOfAKind << handtypeShift)
	handtypeValueTrips         = uint64(Trips << handtypeShift)
	handtypeValueTwoPair       = uint64(TwoPair << handtypeShift)
	handtypeValuePair          = uint64(Pair << handtypeShift)
	handtypeValueHighCard      = uint64(HighCard << handtypeShift)
)

// Pocket Hand 169 Enum
const (
	pocketAA  = 0
	pocketKK  = 1
	pocketQQ  = 2
...
var nBitsAndStrTable = [numberOfGroups]uint64{
	0x00,
	0x04,
	0x04,
	0x08,
...
// 判断几张牌
var nBitsTable = [numberOfGroups]uint64{
	0x00,
	0x01,
	0x01,
	0x02,
...
// 顺子牌型判断并组成顺子的最大牌
var straightTable = [numberOfGroups]uint64{
	0x00,
	0x00,
	0x00,
	0x00,
...
// 获取5张牌的Mask 最高位是最大牌型
var topFiveCardsTable = [numberOfGroups]uint64{
	0x00000000,
	0x00000000,
	0x00010000,
	0x00010000,
...
// 获取最大的一张牌的 Mask
var topCardTable = [numberOfGroups]uint64{
	0x00,
	0x00,
	0x01,
	0x01,
...
// CardMasksTable 每一张牌的Mask值
var cardMasksTable = [numberOfPoker]uint64{
	0x1,
	0x2,
	0x4,
	0x8,
...
var cardTable = [numberOfPoker]string{
...
var ranktbl = [numberOfPoker]string{
...
var suittbl = [numberOfPoker]string{
...
var prePlayerOdds = [numberOfPockets][numberOfHandType]float64{
...
var preOpponentOdds = [numberOfPockets][numberOfHandType]float64{
...
var pocket169Table = [numberOfPockets][]uint64{
